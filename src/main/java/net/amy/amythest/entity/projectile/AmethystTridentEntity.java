...
public class AmethystTridentEntity extends PersistentProjectileEntity  {
	private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(AmethystTridentEntity.class, TrackedDataHandlerRegistry.BYTE);
	private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(AmethystTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	private boolean dealtDamage;
	public int returnTimer;

	public AmethystTridentEntity(EntityType<? extends AmethystTridentEntity> entityType, World world) {
		super(entityType, world);
	}

	public AmethystTridentEntity(World world, LivingEntity owner, ItemStack stack) {
		super(ModEntityType.AMETHYST_TRIDENT, owner, world, stack, null);
		this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
		this.dataTracker.set(ENCHANTED, stack.hasGlint());
	}

	public AmethystTridentEntity(World world, double x, double y, double z, ItemStack stack) {
		super(ModEntityType.AMETHYST_TRIDENT, x, y, z, world, stack, stack);
		this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
		this.dataTracker.set(ENCHANTED, stack.hasGlint());
	}
	...
	protected ItemStack getDefaultItemStack() {
		return new ItemStack(ModItems.AMETHYST_TRIDENT);
	}
