...
public class CherryFoxEntityModel<T extends FoxEntity> extends AnimalModel<T> {
    public static final EntityModelLayer CHERRY_FOX = new EntityModelLayer(Identifier.of(MOD_ID, "cherry_fox"), "main");
    ...
    public CherryFoxEntityModel(ModelPart root) {
